...
public class RecordSyncStatusRequest extends PageRequest {
    ...
    public ResourceActionDO getResourceActionDO() {
        return resourceActionDO;
    }

    public void setResourceActionDO(ResourceActionDO resourceActionDO) {
        this.resourceActionDO = resourceActionDO;
    }

    @Override
    public String toString() {
        return "RecordSyncStatusRequest{" + "resourceActionDO=" + resourceActionDO + '}';
    }
}
