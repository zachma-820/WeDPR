...
public interface SyncStatusMapper {
    ...
    public List<ResourceActionDO> queryResourceRecordMeta(
            @Param("condition") ResourceActionDO condition);

    public Integer queryResourceRecordCount(@Param("condition") ResourceActionDO condition);
}
