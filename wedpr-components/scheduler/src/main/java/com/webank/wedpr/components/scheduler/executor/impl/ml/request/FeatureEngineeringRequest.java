...
public class FeatureEngineeringRequest extends ModelJobRequest {
    @JsonProperty("is_label_holder")
    public Boolean isLabelProvider;

    public FeatureEngineeringRequest(ModelJobRequest modelJobRequest) {
        super(modelJobRequest);
        this.setTaskType(JobType.FeatureEngineer.getType());
    }
